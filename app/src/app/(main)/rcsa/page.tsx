...
// This would typically come from a database or an API
const initialData = [
  {
    no: 1,
...
type RCSAData = typeof initialData[0];
...
export default function RcsasPage() {
  const [data, setData] = useState<RCSAData[]>(initialData);
        ...
        <CardContent className="p-0">
            <div className="overflow-x-auto">
                ...
                <TableHeader>
                    ...
                    <TableHead rowSpan={2} className="text-center align-middle border min-w-[300px]">POTENSI RISIKO</TableHead>
                    <TableHead rowSpan={2} className="text-center align-middle border min-w-[200px]">Jenis Risiko</TableHead>
                    <TableHead rowSpan={2} className="text-center align-middle border min-w-[250px]">PENYEBAB RISIKO</TableHead>
                    <TableHead colSpan={4} className="text-center align-middle border">RISIKO INHEREN</TableHead>
                    <TableHead rowSpan={2} className="text-center align-middle border min-w-[250px]">PENGENDALIAN/MITIGASI RISIKO</TableHead>
