...
import { getRcsaData } from '@/lib/rcsa-data';
                            ...
                            <TableRow key={row.no}>
                                ...
                                <TableCell className="text-center border">
                                    <Input 
                                        ...
                                        onChange={(e) => handleInputChange(index, 'dampakResidual', parseInt(e.target.value, 10))}
                                        className="text-center"
                                    />
                                </TableCell>
                                <TableCell className="text-center border">
                                     <Input 
                                        ...
                                        onChange={(e) => handleInputChange(index, 'kemungkinanResidual', parseInt(e.target.value, 10))}
                                        className="text-center"
                                    />
                                </TableCell>
                                <TableCell className="text-center border font-bold">{!isNaN(besaranResidual) && besaranResidual > 0 ? besaranResidual : ''}</TableCell>
                                <TableCell className="text-center border">
